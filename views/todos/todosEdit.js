  ...
  const content = `
    <div class="flex">
      <form method="post" action="/todos/${x.id}/update">
        <input class="py-2 px-4 border border-blue-500" type="number" name="complete" value="${x.complete}">
        <input class="px-4 border border-blue-500 py-2" name="name" value="${x.name}">
